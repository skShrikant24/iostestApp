...
import 'video_list_professional_model.dart';
export 'video_list_professional_model.dart';

class VideoListProfessionalWidget extends StatefulWidget {
  const VideoListProfessionalWidget({
    super.key,
    this.courseName,
  });
  ...
  @override
  State<VideoListProfessionalWidget> createState() =>
      _VideoListProfessionalWidgetState();
}

class _VideoListProfessionalWidgetState
    extends State<VideoListProfessionalWidget> {
  late VideoListProfessionalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoListProfessionalModel());
                            ...
                            itemBuilder: (context, list2Index) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    FFAppState().videoUrl = functions
                                        .returnlink(list2Item.courseVideoUrl)!;
                                    safeSetState(() {});
