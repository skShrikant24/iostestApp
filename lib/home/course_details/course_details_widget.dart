  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CourseRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CourseRecord> courseDetailsCourseRecordList = snapshot.data!;
        final courseDetailsCourseRecord =
            courseDetailsCourseRecordList.isNotEmpty
                ? courseDetailsCourseRecordList.first
                : null;
            ...
            appBar: AppBar(
              ...
              title: Text(
                valueOrDefault<String>(
                  courseDetailsCourseRecord?.courseName,
                  'Course Name',
                ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        courseDetailsCourseRecord?.desc,
                                        '0',
                                      ),
                                  ...
                                  onTap: () async {
                                    _model.videolink =
                                      ...
                                      queryBuilder: (courseVideoRecord) =>
                                        ...
                                        'course_name',
                                        isEqualTo: courseDetailsCourseRecord
                                            ?.courseName,
                                      ),
                                      singleRecord: true,
