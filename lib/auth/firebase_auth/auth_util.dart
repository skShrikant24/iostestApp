...
DocumentReference? get currentUserReference =>
    loggedIn ? UserPofileRecord.collection.doc(currentUser!.uid) : null;

UserPofileRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserPofileRecord.getDocument(UserPofileRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
