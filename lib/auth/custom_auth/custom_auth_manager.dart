...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    testApplicationAuthUserSubject.add(
      TestApplicationAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TestApplicationAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TestApplicationAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TestApplicationAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    testApplicationAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
TestApplicationAuthUser? currentUser;
