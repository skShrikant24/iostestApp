...
class AppStateNotifier extends ChangeNotifier {
  ...
  TestApplicationAuthUser? initialUser;
  TestApplicationAuthUser? user;
  ...
  void update(TestApplicationAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'QuestionBank',
          path: '/questionBank',
          builder: (context, params) => QuestionBankWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => QuestionBankListWidget(
            courseName: params.getParam(
              'courseName',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'PracticeTest',
          path: '/practiceTest',
          builder: (context, params) => PracticeTestWidget(
            name: params.getParam(
              'name',
              ParamType.String,
            ),
